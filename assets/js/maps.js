    ...
    const properties = [
        ...
        ['Sally Weatherall Reservation', 42.701700, -70.804188, 'sally-sm.jpg', 'Sally-Weatherall-Reservation-and-Viewing-Platform', 15],
        ['Allyn Cox Reservation', 42.633830, -70.764614, 'cox-sm.jpg', 'Allyn-Cox-Reservation', 16],
        //['Donovan Reservation', 42.641327, -70.821890, 'donovan-sm.jpg', 'John-J-Donovan-Reservation-Sagamore-Hill-Conservation-Area', 17],
        ['Harvey Reservation', 42.679187, -70.660575, 'harvey-sm.jpg', 'Harvey-Reservation', 18],
        ['Tompson Street Reservation', 42.620, -70.724, 'tompson-sm.jpg', 'Tompson-Street-Reservation', 19],
        ['Stoney Cove Presson Point', 42.625613, -70.704964, 'stonycove-sm.jpg', 'Stoney-Cove-and-Presson-Point', 20],
    ];

    // When the user clicks the marker, an info window opens.

    function initMap() {
        var centerLatLng = {lat: 42.694674, lng: -70.821945};
